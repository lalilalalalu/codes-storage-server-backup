...
static void objects_generate_random(
...
static void objects_generate_hist_stripe(
    unsigned int max_objs, 
    long unsigned int max_bytes, 
    unsigned int random_seed, 
    unsigned int replication,
...
static void objects_generate_hist_hadoop(
    unsigned int max_objs, 
    long unsigned int max_bytes, 
    unsigned int random_seed, 
    unsigned int replication,
...
static void objects_generate_basic(
    unsigned int max_objs, 
    long unsigned int max_bytes, 
    unsigned int random_seed, 
    unsigned int replication,
    ...
    struct obj** total_objs)
{
    if(strcmp(gen_name, "random") == 0)
        objects_generate_random(max_objs, max_bytes, random_seed, replication,
            num_servers, params,
            total_byte_count, total_obj_count, total_objs);
    else if(strcmp(gen_name, "basic") == 0)
        objects_generate_basic(max_objs, max_bytes, random_seed, replication,
            num_servers, params,
            total_byte_count, total_obj_count, total_objs);
    else if(strcmp(gen_name, "hist_stripe") == 0)
        objects_generate_hist_stripe(max_objs, max_bytes, random_seed, replication,
            num_servers, params,
            total_byte_count, total_obj_count, total_objs);
    else if(strcmp(gen_name, "hist_hadoop") == 0)
        objects_generate_hist_hadoop(max_objs, max_bytes, random_seed, replication,
            num_servers, params,
            total_byte_count, total_obj_count, total_objs);
    else
        assert(0);
...
#endif
        (*total_objs)[*total_objs_count].oid = random_u64();
        r = random();
    ...
    struct obj** total_objs)
{
    ...
    *total_byte_count = 0;
    ...
    while(*total_objs_count < max_objs && *total_byte_count < max_bytes)
    {
        ...
        /* create striped set */
        placement_create_striped(size, replication, (num_servers/replication),
